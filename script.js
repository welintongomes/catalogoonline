        ...
        divCodigo.innerHTML = `
            ...
            <div>
                ...
                <div class="botoes-container">
                    <button class="btn btn-secondary fas fa-edit" onclick="carregarCodigoParaEdicao(${codigo.id})"></button>
                    <button class="btn btn-danger fas fa-trash-alt" onclick="excluirCodigo(${codigo.id})"></button>
                </div>
            </div>
        `;
